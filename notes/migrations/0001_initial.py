...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, help_text='Resource title for the administrator purpose of management', max_length=128, null=True, verbose_name='name')),
                ('description', models.CharField(blank=True, help_text='Title that can be placed below content on the template to describe content', max_length=255, null=True, verbose_name='description')),
