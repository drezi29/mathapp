...
from .exercises_constans import EXERCISE, LIST_OF_EXERCISES, PLACE_FOR_SOLUTION, SHOW_SOLUTION, STEP
from .models import Exercise, Step
from chapters.models import Topic
from chapters.chapter_constans import CONTENT_IN_PREPARATION, INDEX_OF_TOPICS, NOTES, TEST
...
class ExerciseListView(View):
    def get(self, request, pk):
        ...
        return render(request, 'exercises/exercise-list.html',
                      {'exercises': exercises,
                       'topic': topic,
